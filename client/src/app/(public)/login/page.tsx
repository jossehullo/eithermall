        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 pr-12 rounded-lg border border-gray-300 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-400"
              required
            />
